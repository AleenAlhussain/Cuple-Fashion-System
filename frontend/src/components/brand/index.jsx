...
const BrandContainer = ({ params }) => {
  ...
  const { data: Brand, isLoading, refetch } = useFetchQuery([BrandLogo], () => axios({ url: `${BrandLogo}/slug/${params}` }, router), { enabled: !!params, refetchOnWindowFocus: false, select: (res) => res?.data });
