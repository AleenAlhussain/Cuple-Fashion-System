      ...
      {elem?.attribute_values.map((value, index) => (
        <div key={index} className="d-flex digital-price">
          {productState?.attributeValues?.includes(value?.id) ? (
            <div
              onMouseOver={() =>
                setVariant(productState?.product?.variations, value, "hover")
              }
              onMouseOut={() =>
                setVariant(productState?.product?.variations, value, "out")
              }
              onClick={(e) =>
                setVariant(productState?.product?.variations, value, "click")
              }
