...
const RefundModal = ({ modal, setModal, storeData }) => {
  ...
  const { mutate: createRefund } = useCreate("/refund", false, false, t("RefundRequestSubmitted") || "Refund request submitted", () => setModal(false));
        ...
        {({ values, setFieldValue, errors, touched }) => (
          <Form className="product-review-form">
            ...
            <div className="review-box">
              ...
              {errors["reason"] && touched["reason"] && <div className="invalid-feedback d-block">{errors["reason"]}</div>}
            </div>
            <div className="review-box">
              <SimpleInputField nameList={[{ name: "notes", placeholder: t("Notes") || "Notes", type: "textarea", toplabel: "Notes", rows: 3 }]} />
            </div>
            <div className="review-box">
