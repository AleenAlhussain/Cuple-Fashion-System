import { RiAccountBoxLine, RiAlertLine, RiBankCardLine, RiBankLine, RiCheckboxCircleLine, RiCloseCircleLine, RiContactsLine, RiDatabaseLine, RiEarthLine, RiFacebookCircleLine, RiFileListLine, RiGoogleFill, RiGoogleLine, RiGridLine, RiHome4Line, RiImageLine, RiLayoutBottom2Line, RiLayoutTop2Line, RiLineChartLine, RiMailOpenLine, RiPaypalLine, RiPercentLine, RiPhoneLockLine, RiPieChartLine, RiRadioButtonLine, RiRecordCircleLine, RiRefundLine, RiSettingsLine, RiShoppingBasketLine, RiToolsLine, RiTruckLine, RiWallet3Fill, RiWhatsappLine } from "react-icons/ri";
...
export const ProductTabTitleListData = [
  {
    title: "General",
    icon: <RiSettingsLine />,
    inputs: ["product_type", "store_id", "name", "description", "short_description", "description"],
  },
  {
  ...
  },
  {
    title: "Variations",
    icon: <RiDatabaseLine />,
    inputs: ["type", "stock_status", "sku", "quantity", "price", "sale_price", "show_stock_quantity", "discount", "visible_time", "variations"],
  },
  {
    title: "Setup",
    icon: <RiToolsLine />,
    inputs: ["is_sale_enable", "sale_starts_at", "sale_expired_at", "unit", "tags", "brand_id", "is_random_related_products", "related_products", "categories", "cross_sell_products", "upsell_products", "cross_sell_product_id"],
  },
  {
    title: "SEO",
    icon: <RiEarthLine />,
...
export const SettingTabTitleListData = [
  ...
  { title: "WhatsAppConfiguration", icon: <RiWhatsappLine /> },
...
export const ThemeOptionTabTitleListData = [
  { title: "General", icon: <RiSettingsLine /> },
  { title: "HomePageBanner", icon: <RiImageLine /> },
  { title: "HighlightCards", icon: <RiImageLine /> },
  ...
  { title: "HomepageCategories", icon: <RiHome4Line /> },
  { title: "Homepage Products", icon: <RiShoppingBasketLine /> },
  ...
  { title: "ShopLayout", icon: <RiGridLine /> },
  { title: "MatchiMatchi", icon: <RiShoppingBasketLine /> },
];
...
export const popUpTabTitle = [{ title: "NewsLetter" }, { title: "Exit" }, { title: "Auth" }, { title: "SmartPopups" }];
