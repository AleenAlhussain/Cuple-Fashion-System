...
export const optionalEmailSchema = Yup.string().email("Enter Valid Email");
...
export const phoneSchema = Yup.string()
  ...
  .test("phone-validation", function (value) {
    const countryCode = this.parent.country_code || this.parent.shipping_address?.country_code || this.parent.billing_address?.country_code;
...
export const optionalPhoneSchema = Yup.string().test("phone-validation-optional", function (value) {
