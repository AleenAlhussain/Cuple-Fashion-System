...
import { colors } from '@/data/MenuData'
                        ...
                        <CardBody>
                            <div className="title-header">
                                <div className="d-flex align-items-center gap-2">
                                    <h5>{moduleName}</h5>
                                    {edit && data?.id && (
                                        <Link href={`/admin/orders/${data?.id}/edit`} className="btn btn-outline btn-sm d-flex align-items-center gap-1" style={{ color: "#d49d67", borderColor: "#d49d67" }}>
                                            <RiEditLine size={14} />
                                            {t("Edit Order") || "Edit Order"}
                                        </Link>
                                    )}
                                </div>
                                {edit && <Formik 
