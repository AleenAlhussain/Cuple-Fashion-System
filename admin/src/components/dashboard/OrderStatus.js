      ...
      <Card>
        <CardBody>
          ...
          <Row className="g-sm-4 g-3 booking-status-main">
            ...
            <Col xxl="4" sm="6" className="booking-status-card">
              <Link className="booking-widget-card card" href={{ pathname: `/order`, query: { status: "confirmed" } }}>
                <div className="booking-widget-icon">
                  <Image height={26} width={26} src={"/assets/images/svg/cconfirmed.svg"} className="img-fluid" alt="receipt-2" />
                </div>
                <div>
                  <h6>{t("Confirmed")}</h6>
                  <h2>{data?.total_confirmed_orders}</h2>
                </div>
                <Image height={500} width={500} src={"/assets/images/tiles-bg.png"} className="img-fluid abs-icon" alt="box-time" />
              </Link>
            </Col>
            ...
            <Col xxl="4" sm="6" className="booking-status-card">
              <Link className="booking-widget-card card" href={{ pathname: `/order`, query: { status: "out-for-delivery" } }}>
                <div className="booking-widget-icon">
