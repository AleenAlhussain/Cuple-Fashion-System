      ...
      {({ setFieldValue, values, errors }) => (
        <Form className="theme-form theme-form-2 mega-form">
          <Row>
            ...
            {!values["parent_id"] &&
              values["mega_menu"] &&
              (values["mega_menu_type"] === "side_banner" || values["mega_menu_type"] === "bottom_banner" || values["mega_menu_type"] === "product_box") && ( <ChildrenCategory values={values} setFieldValue={setFieldValue}/>)}
