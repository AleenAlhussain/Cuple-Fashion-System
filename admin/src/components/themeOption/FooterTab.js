          ...
          {values["options"]?.["footer"]?.["social_media_enable"] && (
            <SimpleInputField
              nameList={[
                ...
                { name: "[options][footer][tiktok]", title: "TikTok", placeholder: "https://tiktok.com/@yourbrand" },
                { name: "[options][footer][snapchat]", title: "Snapchat", placeholder: "https://snapchat.com/add/yourbrand" },
